...
<div class="m-0 p-0">
      <!-- Top -->
      <section
        class="w-full h-[830px] sm:h-[600px] md:h-[500px] lg:h-[400px] xl:h-[830px] px-8 bg-cover bg-center bg-no-repeat flex justify-center items-center"
        style="
          background-image: url('https://images.unsplash.com/photo-1683009427540-c5bd6a32abf6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop');
        "
      >
        <div class="title text-center text-green-900 mb-6">
          <h2
            class="text-3xl sm:text-2xl md:text-xl lg:text-lg xl:text-4xl mb-6 font-bold"
          >
            WELCOME TO
          </h2>
          <h1
            class="text-6xl sm:text-5xl md:text-4xl lg:text-4xl xl:text-8xl font-bold"
          >
            UMN MEDICAL CENTER
          </h1>
        </div>
      ...
      <!-- Mid -->
      <section
        class="about flex flex-col-reverse h-auto md:h-[670px] md:flex-row-reverse py-8 px-2 md:px-8 bg-slate-50 relative"
      >
        <div
        ...
        >
          <h3
            class="w-full text-center md:text-center xl:text-3xl lg:text-text-2xl font-bold text-xl"
          >
            ABOUT UMN MEDICAL CENTER
          </h3>
          <p
            class="my-6 text-center xl:text-lg lg:text-[16px] md:text-justify text-[14px]"
          >
        ...
        <div
          class="circle flex sm:my-[1%] md:my-[10%] lg:my-14 md:mx-0 lg:mx-[4%] lg:w-[57%] xl:w-[50%] xl:ml-16 md:w-[57%] relative md:mb-0 pb-64 md:pb-0 justify-center md:justify-normal lg:justify-normal xl:justify-normal"
        >
          <div
          ...
          ></div>
          <img
            src="https://images.unsplash.com/photo-1683009427540-c5bd6a32abf6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop"
            class="mt-30 mr-40 mb-2 -ml-6 md:ml-0 absolute w-40 h-40 md:w-44 md:h-44 lg:w-60 lg:h-60 rounded-full"
            alt="pic1"
          />
          <img
            src="https://images.unsplash.com/photo-1683009427540-c5bd6a32abf6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop"
            class="mt-24 mr-16 mb-46 ml-52 md:ml-44 absolute w-[180px] h-[180px] md:w-52 md:h-52 lg:w-72 lg:h-72 lg:mt-32 lg:ml-60 rounded-full"
            alt="pic2"
          />
          <img
            src="https://images.unsplash.com/photo-1683009427540-c5bd6a32abf6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop"
            class="mt-44 mr-32 mb-2 -ml-12 md:ml-8 absolute w-28 h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 lg:mt-72 lg:ml-10 rounded-full"
            alt="pic3"
          />
        </div>
      </section>
      ...
      <section class="bottom bg-lime-800 overflow-hidden py-12">
        ...
        <!-- MISI Section -->
        <div
          class="misi w-full flex flex-row relative justify-center items-center"
        >
          <!-- wrapper -->
          <div
            class="w-0 flex flex-row flex-grow order-1 z-50 items-start
                  relative justify-start self-start
                  md:order-2 md:-ml-5 md:z-0
                  md:justify-center md:items-center md:w-1/3"
          >
            <div
              class="w-8 bg-green-950 flex-grow p-4 order-1 relative -z-1
            ...
            ></div>
            <div
              class="w-64 max-h-64 md:flex flex-grow relative mb-4 order-2 -ml-6 z-50
                    justify-start items-start hidden
                    md:mb-0 md:ml-0 md:-z-1 md:order-1 lg:w-64
                    md:justify-center md:items-center"
            >
              <img class="w-full h-[27rem] xl:h-[29rem] md:h-[29rem] shadow-lg"
                src="https://images.unsplash.com/photo-1609560140261-4efaa689b6c8?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bmF0dXJlJTIwcG9ydHJhaXR8ZW58MHx8MHx8fDA%3D"
                alt=""
              />
            </div>
          </div>
          <!-- misi text -->
          <div class="relative w-full h-auto md:h-[27rem] bg-green-950 text-white p-8 z-50 md:max-h-[27rem] lg:max-w-[70rem] md:max-w-[52rem]">
            <img class="w-48 h-auto shadow-lg float-left m-4 flex md:hidden lg:hidden xl:hidden" src="https://images.unsplash.com/photo-1609560140261-4efaa689b6c8?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bmF0dXJlJTIwcG9ydHJhaXR8ZW58MHx8MHx8fDA%3D" alt=""/>
            <div class="text-sm">
              <h3 class="text-xl md:text-3xl font-bold">MISI</h3>
              <ol class="list-none text-justify text-sm mt-4 space-y-2 md:list-decimal xl:text-lg lg:text-[16px] md:text-[16px] sm:text-sm px-4">
                <li>
