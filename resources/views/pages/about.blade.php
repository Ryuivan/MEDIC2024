...
<div class="bg-[#253A35]">
  <div class="py-16">
    <div class="min-w-screen h-3 bg-[#9BAA89] flex justify-center items-center">
      <h1 class="text-3xl font-bold text-white bg-[#253A35] text-center inline-block px-3">Organigram</h1>
    </div>
  </div>
</div>
...
<div class="bg-[#253A35]">
  <div class="flex flex-col items-center justify-center">
    <div class="w-full md:w-3/4 lg:w-1/2">
      <a href="{{ asset('assets/foto/organigram.jpg') }}" data-fancybox="about">
        <img src="{{ asset('assets/foto/organigram.jpg') }}" class="w-full h-auto object-cover" alt="organigram" />
      </a>
    </div>
  </div>
</div>
